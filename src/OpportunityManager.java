...
public class OpportunityManager {
    ...
    // CSV schema: ID,Name,Type,Link,Status,DueDate,Comments,Flagged,FlagNote
    private static final String HEADER = "ID,Name,Type,Link,Status,DueDate,Comments,Flagged,FlagNote";
